...
\history{Received: 30 June 2016; Accepted: 29 August 2016; Published: date}
%------------------------------------------------------------------
...
\address{%
$^{1}$ \quad Steinwurf ApS. Aalborg {\O}st 9220, Denmark;
nestor@steinwurf.com\\
$^{2}$ \quad Aalborg University, Department of Electronic Systems. Aalborg
{\O}st 9220, Denmark; \{nh, cws, del\}@es.aau.dk\\
$^{3}$ \quad Technische Universit\"at Dresden, Deutsche Telekom Chair of Communication Networks. Dresden 01062, Germany; \{juan.cabrera, frank.fitzek\}@tu-dresden.de, simon.wunderlich@mailbox.tu-dresden.de\\
$^{4}$ \quad SFB 912 -- Collaborative Research Center HAEC. Dresden 01062, Germany}

% Contact information of the corresponding author
\corres{Correspondence: nestor@steinwurf.com, nh@es.aau.dk; Tel.: +45 51 20 03 49}

% Current address and/or shared authorship
\firstnote{Fredrik Bajers Vej 7A, Room A3-110. Aalborg {\O}st 9220, Denmark}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{All authors contributed equally to the work.}
