...
\abstract{Deploying a large-scale and configurable testbed for
  ...
  architecture can be used for other applciations that require
  ...
  for a wide array of configurations are attainable for the Raspberry
  Pi Model 1 and 2, respectively, and that processing energy for
  network coding is below 1 nJ/bit in a large regime and even an order
  of magnitude lower for some algorithms.}
