...
\Title{As Easy as Pi: A Network Coding Raspberry Pi Testbed}
...
Network Coding (NC) reference \cite{ahlswede2000network}.

\section{Testbed Description}
\subsection{System Overview}
\subsection{Installation and Updating}
\subsection{Platform Support: Architectures, OS, compilers and Cross-compilation}
