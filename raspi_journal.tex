...
\AuthorNames{Nestor Hernandez, Chres Soerensen, Juan Cabrera, Simon Wunderlich, Daniel Lucani and Frank Fitzek}
...
$^{3}$ \quad Technische Universit\"at Dresden, Deutsche Telekom Chair of Communication Networks; \{juan.cabrera, simon.wunderlich, frank.fitzek\}@tu-dresden.de\\
$^{4}$ \quad SFB 912 -- HAEC}
...
\lstset{ %
  ...
  breaklines=true,        % the size of the fonts that are used for the code
...
Curie project (317126) from the European Comission FP7 framework, the Green
Mobile Cloud project (Grant No. DFF - 0602 - 01372B) , the TuneSCode project
(Grant No. DFF - 1335 - 00125) both granted by the Danish Council for
Independent Research (Det Frie Forskningsr\r{a}d), and by the German Research
Foundation (DFG) within the Collaborative Research Center SFB 912 – HAEC.}
