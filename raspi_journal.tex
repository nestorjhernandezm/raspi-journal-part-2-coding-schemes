...
\Author{N\'estor J. Hern\'andez Marcano $^{1,\dagger,\ddagger}$, Chres W. S{\o}rensen $^{1,\ddagger}$, Juan A. Cabrera G., Daniel E. Lucani and Frank H. P. Fitzek $^{2,}$*}
% Authors, for metadata in PDF
\AuthorNames{Firstname Lastname, Firstname Lastname and Firstname Lastname}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Steinwuf ApS; nestor@steinwurf.com\\
$^{2}$ \quad Aalborg University, Department of Electronic Systems; nh@es.aau.dk}

% Contact information of the corresponding author
\corres{Correspondence: nh@es.aau.dk; Tel.: +45 51 20 03 49}

% Current address and/or shared authorship
\firstnote{Current address: Affiliation 3}
\secondnote{These authors contributed equally to this work. Authors}
