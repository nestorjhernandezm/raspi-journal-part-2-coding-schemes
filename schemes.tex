...
keeping the structure of the recoded packets for any decoder to compute
the Gaussian elimination. Similarly as with encoding, any decoder that
collects a set of $g$ \ac{l.i.} recoded packets with their respective
${(\textbf{W} \textbf{V})}_{ij}$, will be able to decode the data as mentioned before in Section \ref{sssec:decoding}.
