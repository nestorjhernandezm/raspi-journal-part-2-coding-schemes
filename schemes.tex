...
Provided a desired budget $B$ and the \ac{dof}s of the
decoder, an encoder can estimate the required coding density to not exceed
the required y the budget. ow sparse the coded packets should be to finish a transmission in
time.
