...
Finally, we include a review of the \todot{this sentence is incomplete}
...
[\textbf{reference}]\todot{add ref}. In what follows, we describe the coding
...
The difference between $b$ and $g$ is equal to the losses in the channel and the
...
feedback to be sent from the decoder in [\textbf{reference}].\todot{@Chres this reference is missing}

The transmissions made between feedback packets are called the density regions
...
The idea of the implemented algorithm is to represent each one of the
