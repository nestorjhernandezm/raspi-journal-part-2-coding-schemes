...
Raspberry Pis. We have decided to create a common image of Raspbian Linux
...
It can then be written to a memory card and used in one device
after it has been completely configured  

that
can be written to a memory card and 
