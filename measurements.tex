...
on the generation size. See equation~\eqref{eq:feedback_dofs}.
...
that duplicating\fxnote{What does duplicating the generation size mean? Did you mean doubling?} the generation size does not reduce the goodput by a
...
\mathcal{O}(g^{-2})$. This would imply that duplicating\fxnote{doubling?} the generation
