...
Furthermore, these costs are one order of magnitude less for the \ac{Raspi} 2
with respect to the \ac{Raspi} 1 regarding the case of a fixed generation
size and a variable packet size. This makes the \ac{Raspi} 2 achieve
...
\end{figure*}
%
Some differences occurs due to the nature of decoding. In this situation,
