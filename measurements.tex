...
\ref{sec:energy_metrics_methods}, we compute the metrics described there.
We first proceed with the average power consumption of the \ac{Raspi} 1
in Fig.~\ref{fig:current_rasp1} and the \ac{Raspi} 2 in
Fig.~\ref{fig:current_rasp2}.
