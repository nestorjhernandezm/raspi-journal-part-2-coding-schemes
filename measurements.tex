...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \includegraphics[width=1.2\textwidth]{images/rasp1_good_vs_g_enc_gf2.pdf}
        \caption[]%
    ...
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        \includegraphics[width=1.2\textwidth]{images/rasp1_good_vs_g_enc_gf256.pdf}
        \caption[]%
        {{\small Goodput vs. Generation size for $GF(2^8)$}}    
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        ...
        \caption[]%
        {{\small Goodput vs. Packet size for $GF(2)$}}    
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        ...
        \caption[]%
        {{\small Goodput vs. Packet size for $GF(2^8)$}}    
