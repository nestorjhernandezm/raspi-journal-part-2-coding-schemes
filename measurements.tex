...
% \caption{Gooput measurements for the \ac{Raspi} 1. $q = 2$}
% \label{goodput_enc_rasp1}
% \end{figure}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \includegraphics[width=1.3\textwidth]{images/rasp1_good_vs_g_enc_gf2.pdf}
        \caption[]%
        {{\small $q = 2$}}    
    ...
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        \includegraphics[width=\textwidth]{images/rasp1_good_vs_g_enc_gf256.pdf}
        \caption[]%
        {{\small $q = 2^8$}}    
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{images/rasp1_good_vs_B_enc_gf2.pdf}
        \caption[]%
        {{\small $q = 2$}}    
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        \includegraphics[width=\textwidth]{images/rasp1_good_vs_B_enc_gf256.pdf}
        \caption[]%
        {{\small $q = 2^8$}}    
