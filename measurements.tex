...
\paragraph{Baseline encoding results} The baseline results involve no recording
...
\paragraph{Encoding results} The encoding results were performed using the
...
\paragraph{Decoding results} The differences between encoding and decoding, is
